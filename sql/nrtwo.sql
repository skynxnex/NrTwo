...
CREATE TABLE `expertise` (
  ...
  CONSTRAINT `expertise_ibfk_1` FOREIGN KEY (`expertise_type_id`) REFERENCES
`expertise_type` (`id`) ON DELETE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `expertise` (`id`, `name`, `description`, `expertise_type_id`)
VALUES
...
CREATE TABLE `person__expertise` (
  ...
  CONSTRAINT `person__expertise_ibfk_1` FOREIGN KEY (`persons_id`)
REFERENCES `persons` (`id`) ON DELETE CASCADE,
  CONSTRAINT `person__expertise_ibfk_2` FOREIGN KEY (`expertise_id`)
REFERENCES `expertise` (`id`) ON DELETE NO ACTION
