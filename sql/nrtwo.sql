...
REPLACE INTO `expertise` (`id`, `name`, `description`, `expertise_type_id`) VALUES
...
REPLACE INTO `expertise_like_expertise` (`expertise_id`, `like_expertise_id`) VALUES
(3, 4),
(3, 5),
(7, 8);
...
REPLACE INTO `expertise_type` (`id`, `name`) VALUES
(1, 'Talat språk'),
...
REPLACE INTO `person__expertise` (`persons_id`, `expertise_id`) VALUES
(7, 2),
(11, 3),
(11, 2),
(11, 4),
...
REPLACE INTO `persons` (`id`, `firstname`, `lastname`) VALUES
(1, 'anders', 'olsson'),
(2, 'pelle', 'olsson'),
(3, 'peter', 'olsson'),
(4, 'martin', 'olsson'),
...
REPLACE INTO `projects` (`id`, `name`, `startdate`, `enddate`, `expertise_id`) VALUES
